...
struct L10n {
    ...
    private static let dict: [String: [AppLanguage: String]] = [
        ...
        "thinking_protocol_help_title": [.chinese: "协议对应供应商", .english: "Protocol → Providers"],
        "thinking_protocol_help_enable_thinking": [.chinese: "enable_thinking：智谱 GLM、通义 Qwen、Kimi、火山方舟 Ark", .english: "enable_thinking: GLM, Qwen, Kimi, Ark"],
        "thinking_protocol_help_reasoning_effort": [.chinese: "reasoning_effort：OpenAI o 系列 (o1 / o3 / o4)", .english: "reasoning_effort: OpenAI o-series (o1 / o3 / o4)"],
        "thinking_protocol_help_anthropic_native": [.chinese: "thinking (Anthropic)：Anthropic 原生 API", .english: "thinking (Anthropic): Anthropic native API"],
        "thinking_protocol_help_none": [.chinese: "none：DeepSeek-R1 等模型内置思考", .english: "none: DeepSeek-R1 and models with built-in thinking"],
