...
struct L10n {
    ...
    private static let dict: [String: [AppLanguage: String]] = [
        ...
        "start_codex_adaptor": [.chinese: "启动 Codex 适配服务", .english: "Start Codex Adaptor"],
        "stop_codex_adaptor": [.chinese: "停止 Codex 适配服务", .english: "Stop Codex Adaptor"],
        ...
        "thinking_models_enable_thinking": [.chinese: "支持该字段的模型：Qwen3.5-Plus、Qwen3.6-Plus、Qwen3.7-Max、Qwen3.7-Plus、Qwen3-Coder-Plus、Qwen3-235B-A22B、Qwen3-32B 等", .english: "Models supporting this field: Qwen3.5-Plus, Qwen3.6-Plus, Qwen3.7-Max, Qwen3.7-Plus, Qwen3-Coder-Plus, Qwen3-235B-A22B, Qwen3-32B, etc."],
        "thinking_models_anthropic_native": [.chinese: "支持该字段的模型：Claude Opus 4.7/4.8、Sonnet 4.6、Haiku 4.5、GLM-4.6/5.1/5.2、Kimi K2.6、Kimi K2.7-Code、DeepSeek V4-Pro、doubao-1.5-thinking-pro 等", .english: "Models supporting this field: Claude Opus 4.7/4.8, Sonnet 4.6, Haiku 4.5, GLM-4.6/5.1/5.2, Kimi K2.6, Kimi K2.7-Code, DeepSeek V4-Pro, doubao-1.5-thinking-pro, etc."],
        "thinking_models_none": [.chinese: "支持思考程度调节的模型：o1、o3、o4-mini、gpt-5、gpt-5.2 等", .english: "Models supporting reasoning effort: o1, o3, o4-mini, gpt-5, gpt-5.2, etc."],
        ...
        "help_menu_status": [.chinese: "服务状态 — 菜单栏图标旁同时显示代理服务与 Codex 适配服务的运行状态", .english: "Server Status — the menu bar icon shows the running status of both the proxy server and Codex Adaptor"],
        "help_menu_bypass": [.chinese: "纯代理模式 — 切换是否跳过 API 格式转换", .english: "Bypass Mode — toggle whether to skip API format conversion"],
        ...
        "help_menu_settings": [.chinese: "设置... — 打开设置窗口，切换语言、修改端口、管理追踪日志", .english: "Settings... — open the settings window to switch language, change port, and manage trace logs"],
        "help_menu_launcher": [.chinese: "启动 Claude Code — 打开启动器，配置环境变量后一键启动 Claude Code", .english: "Launch Claude Code — open the launcher to configure env vars and launch Claude Code"],
        "help_menu_control": [.chinese: "启动/停止服务 — 控制代理服务的启停", .english: "Start/Stop Server — start and stop the proxy server"],
        "help_menu_codex_control": [.chinese: "启动/停止 Codex 适配服务 — 控制 Codex 代理服务的启停", .english: "Start/Stop Codex Adaptor — start and stop the Codex proxy service"],
        "help_menu_codex_window": [.chinese: "Codex 适配器 — 打开 Codex 适配器配置窗口", .english: "Codex Adaptor — open the Codex Adaptor config window"],
        ...
        "help_codex_usage_1": [.chinese: "从菜单栏打开「Codex 适配器」", .english: "Open \"Codex Adaptor\" from the menu bar"],
        ...
        "help_faq_a2": [.chinese: "在「设置」窗口修改端口，保存后停止并重新启动服务即可生效。Codex 适配器的端口则在「Codex 适配器」窗口里修改。", .english: "Change the port in the \"Settings\" window, then stop and restart the server to apply. The Codex Adaptor's port is changed in the \"Codex Adaptor\" window."],
        ...
        "help_faq_a6": [.chinese: "在「设置」中改成一个空闲端口（APIBypass 服务）或在「Codex 适配器」窗口改端口（Codex 服务），再重启。", .english: "Switch to a free port in \"Settings\" (for the APIBypass server) or in the \"Codex Adaptor\" window (for the Codex server), then restart."],
