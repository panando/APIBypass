...
struct L10n {
    ...
    private static let dict: [String: [AppLanguage: String]] = [
        ...
        "help_faq_a10": [.chinese: "在「增强」标签页，点击调试端口旁的 ⓘ 按钮，复制显示的命令到终端执行即可。命令格式类似：/Applications/ChatGPT.app/Contents/MacOS/ChatGPT --remote-debugging-port=9222", .english: "In the \"Enhancements\" tab, click the ⓘ button next to the debug port, then copy and run the displayed command in your terminal. The command format is similar to: /Applications/ChatGPT.app/Contents/MacOS/ChatGPT --remote-debugging-port=9222"],
        ...
        "codex_launch_progress_detect": [.chinese: "正在检测 Codex/ChatGPT…", .english: "Detecting Codex/ChatGPT…"],
        ...
        "codex_launch_app_not_found": [.chinese: "未找到 Codex/ChatGPT（已检查 /Applications 和 ~/Applications）", .english: "Codex/ChatGPT not found (checked /Applications and ~/Applications)"],
